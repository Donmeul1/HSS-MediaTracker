        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Infix = table.Column<string>(maxLength: 15, nullable: true),
                    LastName = table.Column<string>(maxLength: 50, nullable: false),
                    Bio = table.Column<string>(maxLength: 2500, nullable: true),
                    BooksWritten = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Illustrations = table.Column<bool>(nullable: false),
                    ...
                    Binding = table.Column<byte>(nullable: false),
                    HasMap = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Note_IdentityUser_UserId",
                        column: x => x.UserId,
